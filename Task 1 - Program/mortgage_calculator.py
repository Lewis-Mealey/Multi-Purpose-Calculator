...
def helpo():
    ...
    Popen('python mortgage_help.py')

#########################################################################

label1 = tk.Label(calc, text='Mortgage Calculator')
label1.config(font=('helvetica', 14))
window.create_window(200, 25, window=label1)

label2 = tk.Label(calc, text='Mortgage amount')
...
label4 = tk.Label(calc, text='Mortgage period (years)')
...
def mortageamount ():
    ...
    mortgagetotal = tk.Label(calc, text= round(monthly_payment,2),font=('helvetica', 10, 'bold'))
    window.create_window(200, 320, window=mortgagetotal)
